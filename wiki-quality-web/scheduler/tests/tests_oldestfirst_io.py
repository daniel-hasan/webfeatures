...
class TestOldestScheduler(TestCase):
    ...
    def setUp(self):
        ...
        date0 = timezone.datetime.strptime("2018-03-27 12:05:00", '%Y-%m-%d %H:%M:%S') 
        date1 = timezone.datetime.strptime("2018-03-27 12:34:00", '%Y-%m-%d %H:%M:%S') 
        date2 = timezone.datetime.strptime("2018-03-27 12:55:00", '%Y-%m-%d %H:%M:%S') 
