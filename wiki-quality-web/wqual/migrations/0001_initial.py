# Generated by Django 2.0.1 on 2018-01-30 03:13

from django.conf import settings
import django.core.validators
from django.db import migrations, models
import django.db.models.deletion
import wqual.models.utils
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dsc_result', wqual.models.utils.CompressedTextField()),
                ('document', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='wqual.Document')),
            ],
        ),
        migrations.CreateModel(
            name='DocumentText',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('val_cost_time', models.IntegerField(validators=[django.core.validators.MaxValueValidator(9999999999)])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_argument', models.CharField(choices=[('int', 'int'), ('string', 'string'), ('json', 'json')], default='string', max_length=10)),
