 ...
 */
 function format_feature_set_url(strTemplateURL,strFeatureSet){
 	return strTemplateURL.replace("__feature_set__",strLanguageCode);
 }
...
function insertFeatures(arrFeaturesNames,strFeatureSet){
	...
	$.ajax({
	  url: format_feature_set_url("{% url "list_all_features" "__feature_set__" %}",strFeatureSet),
	  dataType: 'json',
	  type: "POST",
 ...
 * @since  09/02/2018
 */
function inserNewFeatureItem(objFeatureItem){
