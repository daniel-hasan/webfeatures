...
urlpatterns = [
    ...
    url(r'^featureSetConfig/(?P<nam_feature_set>[^/]*)/insertFeatures$', views.InsertUsedFeaturesView.as_view(), name='insert_used_features'),
    url(r'^featureSetConfig/(?P<nam_feature_set>[^/]*)/getAllFeatures/$', views.InsertUsedFeaturesView.as_view(), name='insert_used_features'),
